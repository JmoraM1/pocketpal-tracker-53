...
No quiero que `+ Nuevo` pase obligatoriamente a una segunda fila en todos los móviles. Quiero que conserve la composición actual de referencia y que solo cambie de distribución cuando realmente no exista espacio suficiente. La adaptación debe ser determinista y visualmente consistente, sin depender del wrap automático del contenido.
